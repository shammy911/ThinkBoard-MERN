...
const NoteDetailPage = () => {
  ...
  // If loading finished but note is null, show a friendly message instead of crashing
  if (!loading && !note) {
    return (
      <div className='min-h-screen bg-base-200 flex items-center justify-center'>
        <div className='text-center'>
          <h2 className='text-2xl font-bold mb-2'>Note not found</h2>
          <p className='mb-4'>The note you're looking for doesn't exist or has been deleted.</p>
